...
<head>
    <head>
        ...
        <link href="{{asset('templates/assets/css/loader.css')}}" rel="stylesheet" type="text/css" />
        <script src="{{asset('templates/assets/js/loader.js')}}"></script>
        ...
        <link href="{{asset('templates/plugins/apex/apexcharts.css')}}" rel="stylesheet" type="text/css">
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <li class="nav-item theme-text">
                    <a href="index.html" class="nav-link"> EBook </a>
                </li>
            </ul>
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu menu-heading">
                    <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-minus"><line x1="5" y1="12" x2="19" y2="12"></line></svg><span>Pengguna Aplikasi</span></div>
                </li>                    
